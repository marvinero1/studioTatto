...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="float-right">
            <a href="<?php echo e(route('blog.create')); ?>" class="btn btn-app" class="btn btn-danger btn-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <img src="/<?php echo e($blogs->imagen); ?>" alt="<?php echo e($blogs->nombre_cliente); ?>" width="150px;"></td>
                        <td style="text-align:center;"><?php echo e($blogs->nombre_cliente); ?></td>
                        <td style="text-align:center;"><?php echo e($blogs->detalle); ?></td>
                        <td style="text-align:center;"><?php echo e($blogs->created_at); ?> </td>

                        <td style="text-align:center;">
                            <form action="<?php echo e(route('blog.destroy',$blogs->id )); ?>" method="POST"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\studioTatto\resources\views/testimonial/index.blade.php ENDPATH**/ ?>