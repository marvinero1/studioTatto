                ...
                <div class="col-md-12">
                    <div class="card card-yellow p-3">
                        ...
                        <div class="card-footer">
                            <a href="<?php echo e(url('/productos')); ?>"><button class="btn  float-right" style="color: white"> <i class="fas fa-window-close"></i>
                                Cancelar</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\studioTatto\resources\views/producto/create.blade.php ENDPATH**/ ?>