    ...
    <div class="content">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php $__currentLoopData = $artista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artistas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="text-align:center;">
                            <img src="/<?php echo e($artistas->imagen); ?>" alt="<?php echo e($artistas->nombre); ?>"
                            width="125px;"></td>

                        <td style="text-align:center;"><?php echo e($artistas->nombre_artista); ?></td>
                        <td style="text-align:center;"><?php echo e($artistas->rol); ?></td>


                        <td style="text-align:center;">

                            <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#exampleModalShow<?php echo e($artistas->id); ?>">
                                <i class="fas fa-eye"></i> Ver
                            </button>

                            <form action="<?php echo e(route('artistas.destroy',$artistas->id )); ?>" method="POST"
                            ...
                            <!-- Modal SHOW-->
                            <div class="modal fade" id="exampleModalShow<?php echo e($artistas->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        name="nombre_artista"  placeholder="<?php echo e($artistas->nombre_artista); ?>" disabled>
		                                    </div>
                                    	</div>
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="facebook" placeholder="<?php echo e($artistas->rol); ?>" disabled>
		                                    </div>
                                    	</div>
                                    </div>
                                    ...
                                    <div class="row">
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="facebook" placeholder="<?php echo e($artistas->facebook); ?>" disabled>
		                                    </div>
                                    	</div>
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="instagram" placeholder="<?php echo e($artistas->instagram); ?>" disabled>
		                                    </div>
                                    	</div>
                                    </div>
                                    ...
                                    <div class="row">
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="twitter" placeholder="<?php echo e($artistas->twitter); ?>" disabled>
		                                    </div>
                                    	</div>
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="whatsapp" placeholder="<?php echo e($artistas->whatsapp); ?>" disabled>
		                                    </div>
                                    	</div>
                                    </div>
                                    ...
                                    <div class="row">
                                    	<div class="col">
                                    		<div class="input-group mb-3 pt-3">
		                                        ...
		                                        <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"
		                                        name="telegram" placeholder="<?php echo e($artistas->telegram); ?>" disabled>
		                                    </div>
                                    	</div>
                                    </div>
                    ...
                    <div class="modal-dialog" role="document" style="max-width: 600px !important;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="text-align: center;">
                                <form action="<?php echo e(route('artistas.store')); ?>" method="POST" enctype="multipart/form-data"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\studioTatto\resources\views/artista/index.blade.php ENDPATH**/ ?>